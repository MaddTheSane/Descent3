...
void GetGameAPI(game_api *api) {
  ...
  api->fp[197] = (int *)vec::vm_GetMagnitude;
  api->fp[198] = (int *)vec::vm_MatrixMulVector;
  api->fp[199] = (int *)phys_apply_force;
  api->fp[200] = (int *)phys_apply_rot;
  api->fp[201] = (int *)vec::vm_TransposeMatrix;
  api->fp[202] = (int *)vec::vm_CrossProduct;
  api->fp[203] = (int *)vec::vm_NormalizeVector;
  api->fp[204] = (int *)ConvertEulerToAxisAmount;
  api->fp[205] = (int *)ConvertAxisAmountToEuler;
  api->fp[206] = (int *)vec::vm_GetMagnitudeFast;
  api->fp[207] = (int *)vec::vm_MakeIdentity;
  api->fp[208] = (int *)dvm_MakeZeroVector;
  api->fp[209] = (int *)dvm_MakeZeroAngle;
  api->fp[210] = (int *)vec::vm_VectorMulTMatrix;
  api->fp[211] = (int *)vec::vm_MatrixMul;
  api->fp[212] = (int *)vec::vm_MatrixMulTMatrix;
  api->fp[213] = (int *)vec::vm_DotProduct;
  api->fp[214] = (int *)vec::vm_SubVectors;
  api->fp[215] = (int *)vec::vm_AddVectors;
  api->fp[216] = (int *)vec::vm_AverageVector;
  api->fp[217] = (int *)vec::vm_ScaleVector;
  api->fp[218] = (int *)vec::vm_ScaleAddVector;
  api->fp[219] = (int *)vec::vm_DivVector;
  api->fp[220] = (int *)vec::vm_NormalizeVectorFast;
  api->fp[221] = (int *)vec::vm_ClearMatrix;
  api->fp[222] = (int *)vec::vm_AnglesToMatrix;
  api->fp[223] = (int *)vec::vm_Orthogonalize;
  api->fp[224] = (int *)vec::vm_VectorToMatrix;
  api->fp[225] = (int *)vec::vm_VectorAngleToMatrix;
  api->fp[226] = (int *)vec::vm_SinCos;
  api->fp[227] = (int *)vec::vm_GetSlope;
  api->fp[228] = (int *)vec::vm_GetPerp;
  api->fp[229] = (int *)vec::vm_GetNormal;
  api->fp[230] = (int *)vec::vm_VectorDistance;
  api->fp[231] = (int *)vec::vm_VectorDistanceQuick;
  api->fp[232] = (int *)vec::vm_GetNormalizedDir;
  api->fp[233] = (int *)vec::vm_GetNormalizedDirFast;
  api->fp[234] = (int *)vec::vm_ExtractAnglesFromMatrix;
  api->fp[235] = (int *)vec::vm_DeltaAngVec;
  api->fp[236] = (int *)vec::vm_DeltaAngVecNorm;
  api->fp[237] = (int *)vec::vm_DistToPlane;
  api->fp[238] = (int *)vec::calc_det_value;
  api->fp[239] = (int *)vec::vm_MakeInverseMatrix;
  api->fp[240] = (int *)vec::vm_SinCosToMatrix;
  api->fp[241] = (int *)vec::vm_GetCentroid;
  api->fp[242] = (int *)vec::vm_MakeRandomVector;
  api->fp[243] = (int *)vec::vm_ComputeBoundingSphere;
  api->fp[244] = (int *)vec::vm_GetCentroidFast;
