...
void OnServerCollide(object *me_obj, object *it_obj, simd::float3 *point, simd::float3 *normal) {
  ...
  if (me_obj->handle == Monsterball_info.objhandle) {
    ...
    case OBJ_WEAPON: {
      ...
      winfo.orient.columns[2].x = it_obj->orient.columns[2].x;
      winfo.orient.columns[2].y = it_obj->orient.columns[2].y;
      winfo.orient.columns[2].z = it_obj->orient.columns[2].z;
      winfo.orient.columns[1].x = it_obj->orient.columns[1].x;
      winfo.orient.columns[1].y = it_obj->orient.columns[1].y;
      winfo.orient.columns[1].z = it_obj->orient.columns[1].z;
      winfo.orient.columns[0].x = it_obj->orient.columns[0].x;
      winfo.orient.columns[0].y = it_obj->orient.columns[0].y;
      winfo.orient.columns[0].z = it_obj->orient.columns[0].z;
